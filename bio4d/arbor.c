...
bye:
	 ...
	 *  panic() implies that the master bio4d process may simply shutdown
	 *  the request process before the request has a chance to reply to the
...
fork_arborist()
{
	...
	ps_title_set("bio4d-arborist", (char *)0, (char *)0);
